...
from plots import plot_config, get_map_plot, get_country_timeseries,get_bar_plot2,get_country_timeseries_new
...
app.layout = dbc.Container([
    ...
    html.Hr(),
         dbc.Row([  
        dbc.Col(html.P(""), md=2),        
        dbc.Col([html.H2("Daily New  Cases")],md=8)
        ],align="center"),
